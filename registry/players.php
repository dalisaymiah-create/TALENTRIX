<?php
// players.php - Standalone Player Management Page
session_start();
require_once 'db.php';
...
try {
    ...
    error_log("Error fetching all players: " . $e->getMessage());
    $all_players = [];
}
...
<head>
    ...
    <title>TALENTRIX - Player Management</title>
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="header">
                <div>
                    ...
                    <p>Manage all your players in one place</p>
                </div>
                <div class="header-actions">
                    <div class="search-box">
                        <i class="fas fa-search"></i>
                        <input type="text" placeholder="Search players..." id="globalSearch">
                    </div>
            ...
            <div class="players-card">
                <div class="page-header">
                    <h2><i class="fas fa-users me-2" style="color: #f59e0b;"></i> All Players (<?php echo count($all_players); ?>)</h2>
                    <button class="add-btn" onclick="openAddPlayerModal()">
                        <i class="fas fa-user-plus"></i> Add New Player
                    </button>
                </div>

                <div class="search-wrapper">
                    <input type="text" id="playerSearch" placeholder="Search players by name or ID..." onkeyup="searchPlayers()">
                </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="player-info">
                                            ...
                                            <div>
                                                <div class="player-name"><?php echo htmlspecialchars($p['first_name'] . " " . $p['last_name']); ?></div>
                                                <div class="player-id">ID: <?php echo htmlspecialchars($p['id_number']); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="position-badge">
                                            <?php echo htmlspecialchars($p['primary_position'] ?? 'Not Set'); ?>
                                        </span>
                                    </td>
                                    <td>
                                        <?php echo htmlspecialchars($p['primary_sport'] ?? 'Basketball'); ?>
                                    </td>
                                    <td>
                                        <?php 
                                        $height = $p['height'] ?? '—';
                                        $weight = $p['weight'] ?? '—';
                                        echo htmlspecialchars($height . " cm / " . $weight . " kg");
                                        ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="#" class="action-btn" onclick="viewPlayer(<?php echo $p['id']; ?>)">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="#" class="action-btn" onclick="editPlayer(<?php echo $p['id']; ?>)">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="#" class="action-btn" onclick="deletePlayer(<?php echo $p['id']; ?>)">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="6" class="empty-state">
                                        ...
                                        <small>Click "Add New Player" to get started</small>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
    ...
    <div id="addPlayerModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="add_student.php" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="height" placeholder="e.g., 180">
                </div>
                <div class="form-group">
                    <label>Weight (kg)</label>
                    <input type="number" name="weight" placeholder="e.g., 75">
                </div>
                <div class="form-group">
